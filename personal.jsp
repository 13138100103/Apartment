 ...
 <!--data-toggle collapse 折叠  ul class =collapse 初始折叠 -->
    ...
    <i class="glyphicon glyphicon-cog"></i>后台管理 <span class="pull-right glyphicon glyphicon-chevron-down"></span><br/> </a> 
     ...
     <!--data-toggle collapse 折叠   collapse in 初始不折叠-->
        <div> <a href="#userSetting"  data-toggle="collapse in"> 
      ...
      <li> <a href="updatehouse.jsp" class="ex0 active"> <i class="glyphicon glyphicon-pencil"></i> 发布新房 </a> </li>
        <li class="active"> <a href="personal.jsp"> <i class="glyphicon glyphicon-user"></i> 个人资料</a> </li>
  ...
  <!--   折叠结束 -->
    ...
    <div class=" col-md-8 publish wow fadeInUp" id="right"><!-- 将数据appendTo tbody 定义id -->
      <form class="form-horizontal" action="${pageContext.request.contextPath}/personal/data"
				method="post">
		 <div class="form-group">
          <label  class="col-sm-2">ID:</label>
          <div class="col-sm-3">
            <input type="text" class="form-control" id="title" name="id" value="${sessionScope.user.id}" readonly="readonly">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="text" class="form-control" id="title" name="username" value="${sessionScope.user.username}" readonly="readonly">
            <span	class="help-block"></span> </div>
        </div>
        <div class="form-group">
          <label  class="col-sm-2">密码:</label>
          <div class="col-sm-3">
            <input type="text" class="form-control" id="title" name="password" value="${sessionScope.user.password}">
            <span	class="help-block"></span> </div>
        </div>
                <div class="form-group">
          <label  class="col-sm-2">手机:</label>
          <div class="col-sm-3">
            <input type="text" class="form-control" id="title" name="phone" value="${sessionScope.user.phone}">
            <span	class="help-block"></span> </div>
        </div>
                <div class="form-group">
          <label  class="col-sm-2">邮箱:</label>
          <div class="col-sm-3">
            <input type="text" class="form-control" id="title" name="email" value="${sessionScope.user.email}">
            <span	class="help-block"></span> </div>
        </div>
        ...
        <br/>
        <br/>
        <button type="submit" class="btn btn-primary  col-sm-2 col-md-offset-2" id="expaddbtn">更改资料</button>
