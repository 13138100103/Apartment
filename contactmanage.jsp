 ...
 <!--data-toggle collapse 折叠  ul class =collapse 初始折叠 -->
    ...
    <i class="glyphicon glyphicon-cog"></i>后台管理 <span class="pull-right glyphicon glyphicon-chevron-down"></span><br/> </a> 
      ...
      <ul id="systemSetting" class="nav nav-pills nav-stacked collapse in">
        ...
        <li class="active"> <a href="manage/contactmanage"> <i class="glyphicon glyphicon-heart"></i>客户回复</a></li> 
...
<c:forEach var="contact" items="${requestScope.contact}">
		<tr>
          ...
          <td>${contact.time}</td>
          <td class="td-manage">
          <a title="删除" href="manage/contactdelete?id=${contact.id}"  class="btn btn-xs btn-warning" ><i class="icon-trash  bigger-120"></i>删除</a>
          </td>
		</tr>
</c:forEach>		
