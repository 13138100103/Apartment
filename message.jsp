    ...
    <i class="glyphicon glyphicon-cog"></i>后台管理 <span class="pull-right glyphicon glyphicon-chevron-down"></span><br/> </a> 
     ...
     <!--data-toggle collapse 折叠   collapse in 初始不折叠-->
      ...
      <li> <a href="updatehouse.jsp" class="ex0 active"> <i class="glyphicon glyphicon-pencil"></i> 发布新房 </a> </li>
        ...
        <li   class="active"> <a href="personal/message" class="ex0 active"> <i class="glyphicon glyphicon-inbox"></i> 我的留言</a> </li>
...
<c:forEach var="message" items="${requestScope.message}">
		<tr>
          ...
          <td>${message.time}</td>
          <td class="td-manage">
          <a title="删除" href="personal/messagedelete?id=${message.id}"  class="btn btn-xs btn-warning" ><i class="icon-trash  bigger-120"></i>删除</a>
          </td>
		</tr>
</c:forEach>		
